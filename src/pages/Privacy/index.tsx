      ...
      <div className="py-16">
        ...
        <div className=" p-8 mt-16 rounded-lg">
          <div className="text-gray-600 flex flex-col space-y-4">
            ...
            <p className="text-2xl font-semibold">Interpretation</p>
            <p>
            ...
            <p>
              ...
              where &ldquo;control&ldquo; means ownership of 50% or more of the shares, equity interest or other
              securities entitled to vote for election of directors or other managing authority.
            </p>
            <p>
              <b>Company</b> (referred to as either &ldquo;the Company&ldquo;, &ldquo;We&ldquo;, &ldquo;Us&ldquo; or
              &ldquo;Our&ldquo; in this Agreement) refers to Sota.
            </p>
            <p>
            ...
            <p>
              <b>Website</b> refers to Sota, accessible from{' '}
              <a href="https://sota-free.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <p className="text-2xl font-semibold">Types of Data Collected</p>
            ...
            <p>
              Usage Data may include information such as Your Device&lsquo;s Internet Protocol address (e.g. IP
            ...
            <p className="text-xl font-semibold">Tracking Technologies and Cookies</p>
            <p>
            ...
            <p>
              Cookies can be &ldquo;Persistent&ldquo; or &ldquo;Session&ldquo; Cookies. Persistent Cookies remain on
            ...
            <p>
              <b>To provide</b> You with news, special offers and general information about other goods, services and
            ...
            <p>
              Your information, including Personal Data, is processed at the Company&lsquo;s operating offices and in
            ...
            <p className="text-2xl font-semibold">Delete Your Personal Data</p>
            <p>
            ...
            <p className="text-3xl font-semibold">Children&lsquo;s Privacy</p>
            <p>
            ...
            <p>
              ...
              consent from a parent, We may require Your parent&lsquo;s consent before We collect and use that
              information.
            </p>
            <p className="text-3xl font-semibold">Links to Other Websites</p>
            <p>
              Our Service may contain links to other websites that are not operated by Us. If You click on a third party
              link, You will be directed to that third party&lsquo;s site. We strongly advise You to review the Privacy
            ...
            <p className="text-3xl font-semibold">Changes to this Privacy Policy</p>
            <p>
            ...
            <p>
              ...
              effective and update the &ldquo;Last updated&ldquo; date at the top of this Privacy Policy.
            </p>
            <p>
            ...
            <p>By email: transybao28@gmail.com</p>
          </div>
        </div>
      </div>
    </PageContainer>
